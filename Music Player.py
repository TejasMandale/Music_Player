...
class MusicPlayer:
    ...
    def __init__(self, root):
        ...
        self.root.title("SaReGaMa Music")
        ...
        self.bg_image =  tk.PhotoImage(file = os.path.join(os.getcwd(), "Code_Music_Player/music", "image1.png"))
        ...
        self.bg_image3 =  tk.PhotoImage(file = os.path.join(os.getcwd(), "Code_Music_Player/music", "image2.png"))
